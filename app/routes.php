...
/* RUTAS TEMPORALES DE NUEVO DISEÑO PERFILES */

	Route::match(array('GET','POST'),'/inicioPapa','perfilController@inicioPapa');
	Route::match(array('GET','POST'),'/misHijos','perfilController@misHijos');
	Route::match(array('GET','POST'),'/puntajes','perfilController@puntajes');
	Route::match(array('GET','POST'),'/alertas','perfilController@alertas');

	Route::match(array('GET','POST'),'/inicioHijo','perfilController@inicioHijo');
	Route::match(array('GET','POST'),'/tienda','perfilController@tienda');
