$(document).ready(function(){
	...
	$('#cancelar').click(function(){
		...
		$("#telefono").attr('type','hidden');
		$("#username").attr('type','hidden');
		$(".text-muted").slideDown();
		$("#edit_datos").slideDown();
...
// FUNCIONAMIENTO DEL SLIDER "by fernandoCNLS"
...
$(function(){
	var SliderModule = (function(){
		...
		var SliderInit = function(){
			SliderInterval = setInterval(pb.starSlider, 6000);
		}
